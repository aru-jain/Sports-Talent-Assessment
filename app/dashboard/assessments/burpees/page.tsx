...
const assessmentData = {
  ...
  tips: [
    ...
    'Keep your core engaged during the plank phase',
    'Land softly when jumping to reduce impact'
  ]
}

export default function BurpeesAssessmentPage() {
  ...
  const startProcessing = () => {
    ...
    setTimeout(() => {
      const results = generateMockStats('burpees')
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">Record yourself performing burpees and upload the video</p>
            </div>
          </div>
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">AI is analyzing your burpee performance</p>
            </div>
          </div>
          ...
          <div className="bg-primary-50 border border-primary/20 rounded-2xl p-6">
            <div className="space-y-3 text-sm text-primary-dark">
              ...
              <p className="flex items-center gap-2">
                ...
                Extracting form and endurance data
              </p>
              <p className="flex items-center gap-2">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">Your burpee performance has been analyzed</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-surface border border-border-light rounded-2xl p-4 text-center">
              ...
              <div className="text-sm text-muted">Burpees</div>
            </div>
            <div className="bg-surface border border-border-light rounded-2xl p-4 text-center">
