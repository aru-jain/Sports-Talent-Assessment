...
const assessmentData = {
  ...
  instructions: [
    ...
    'Engage your core and lift your torso up towards your knees',
    'Lower back down with control to the starting position',
    'Maintain steady breathing throughout the movement'
  ],
  tips: [
    'Keep your feet flat on the ground throughout',
    'Focus on using your core, not pulling on your neck',
    'Maintain a steady rhythm for consistent performance',
    'Exhale as you sit up, inhale as you lower down'
  ]
}

export default function SitUpsAssessmentPage() {
  ...
  const startProcessing = () => {
    ...
    setTimeout(() => {
      const results = generateMockStats('sit-ups')
  ...
  return (
    <div className="flex-1 px-6 py-6 space-y-6">
      ...
      {/* Upload, Processing, and Results steps remain the same as push-ups but with sit-ups specific content */}
      {currentStep === 'upload' && (
        <motion.div
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">Record yourself performing sit-ups and upload the video</p>
            </div>
          </div>
      ...
      {/* Processing and Results steps similar to other assessments */}
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">AI is analyzing your sit-up performance</p>
            </div>
          </div>
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">Your sit-up performance has been analyzed</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-surface border border-border-light rounded-2xl p-4 text-center">
              ...
              <div className="text-sm text-muted">Sit-ups</div>
            </div>
            <div className="bg-surface border border-border-light rounded-2xl p-4 text-center">
