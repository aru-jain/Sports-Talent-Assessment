...
const assessmentData = {
  ...
  instructions: [
    ...
    'Push back up to the starting position and repeat with other leg',
    'Maintain proper posture and balance throughout the movement'
  ],
  tips: [
...
export default function LungesAssessmentPage() {
  ...
  const startProcessing = () => {
    ...
    setTimeout(() => {
      const results = generateMockStats('lunges')
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">Record yourself performing lunges and upload the video</p>
            </div>
          </div>
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">AI is analyzing your lunge performance</p>
            </div>
          </div>
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">Your lunge performance has been analyzed</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-surface border border-border-light rounded-2xl p-4 text-center">
              ...
              <div className="text-sm text-muted">Lunges</div>
            </div>
            <div className="bg-surface border border-border-light rounded-2xl p-4 text-center">
