...
import { 
  Zap, Play, Upload, Camera, CheckCircle, AlertCircle, 
  Clock, Users, Medal, ArrowLeft, Shield, Target, 
...
const assessmentData = {
  ...
  instructions: [
    ...
    'Start at one end of the ladder in an athletic position',
    'Perform the designated footwork pattern through each rung',
    'Maintain quick, light steps throughout the drill',
    'Complete the pattern with precision and speed'
  ],
  tips: [
    'Stay on the balls of your feet for quick movement',
    'Keep your knees slightly bent and body low',
    'Focus on accuracy first, then increase speed',
    'Maintain rhythm and avoid rushing the pattern'
  ]
}

export default function AgilityLadderAssessmentPage() {
  ...
  const startProcessing = () => {
    ...
    setTimeout(() => {
      const results = generateMockStats('agility-ladder')
  ...
  return (
    <div className="flex-1 px-6 py-6 space-y-6">
      ...
      {/* Upload, Processing, and Results steps remain similar to other assessments */}
      {currentStep === 'upload' && (
        <motion.div
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">Record your agility ladder drill and upload the video</p>
            </div>
          </div>
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">AI is analyzing your agility performance</p>
            </div>
          </div>
          ...
          <div className="bg-primary-50 border border-primary/20 rounded-2xl p-6">
            <div className="space-y-3 text-sm text-primary-dark">
              ...
              <p className="flex items-center gap-2">
                ...
                Extracting speed and coordination data
              </p>
              <p className="flex items-center gap-2">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">Your agility ladder performance has been analyzed</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-surface border border-border-light rounded-2xl p-4 text-center">
              ...
              <div className="text-sm text-muted">Patterns</div>
            </div>
            <div className="bg-surface border border-border-light rounded-2xl p-4 text-center">
