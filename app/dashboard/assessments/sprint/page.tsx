...
import { 
  Medal, Play, Upload, Camera, CheckCircle, AlertCircle, 
  Clock, Users, ArrowLeft, Shield, Zap, Target, 
...
const assessmentData = {
  ...
  instructions: [
    'Position yourself at the starting line in a standing start position',
    'When ready, sprint at maximum speed for the full 50 meters',
    'Maintain proper running form throughout the sprint',
    'Record the time from start to finish line crossing',
    'Ensure clear side view of the entire sprint distance'
  ],
  tips: [
    'Warm up thoroughly with dynamic stretches',
    'Focus on driving your arms for maximum speed',
    'Maintain slight forward lean during acceleration',
...
export default function SprintAssessmentPage() {
  ...
  const startProcessing = () => {
    ...
    setTimeout(() => {
      const results = generateMockStats('sprint')
  ...
  return (
    <div className="flex-1 px-6 py-6 space-y-6">
      ...
      {/* Upload, Processing, Results steps similar to other assessments */}
      {currentStep === 'upload' && (
        <motion.div
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">Record your 50m sprint and upload the video</p>
            </div>
          </div>
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">AI is analyzing your sprint performance</p>
            </div>
          </div>
          ...
          <div className="bg-primary-50 border border-primary/20 rounded-2xl p-6">
            <div className="space-y-3 text-sm text-primary-dark">
              ...
              <p className="flex items-center gap-2">
                ...
                AI motion tracking and speed analysis
              </p>
              <p className="flex items-center gap-2">
                ...
                Extracting timing and form data
              </p>
              <p className="flex items-center gap-2">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-muted">Your sprint performance has been analyzed</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-surface border border-border-light rounded-2xl p-4 text-center">
              ...
              <div className="text-sm text-muted">Sprint Time</div>
            </div>
            <div className="bg-surface border border-border-light rounded-2xl p-4 text-center">
              <div className="text-2xl font-bold text-foreground">{(50 / (mockResults.duration / 10)).toFixed(1)} m/s</div>
